...
def getWeather():
    ...
    try:
        ...
        print("Error: Insufficient privileges for geocoding service")
    except Exception as e:
        print(f"Error: {e}")

        #weather
    api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=#ur_api_id"
    ...
    #print(f"Local time in {city}: {current_time}")
